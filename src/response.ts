...
const loadRaw: SendLayer<any>[0] = (self, scope, params, paramsCount) =>
  'return new Response(' +
...
const loadJSON: SendLayer<any>[0] = (self, scope, params, paramsCount) =>
...
const loadHTML: SendLayer<any>[0] = (self, scope, params, paramsCount) => {
